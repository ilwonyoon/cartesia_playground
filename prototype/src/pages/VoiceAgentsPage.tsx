...
function AgentRow({ agent }: { agent: Agent }) {
  return (
    <a className="group flex items-center gap-3 px-6 py-5 cursor-pointer border-b border-neutral-100 last:border-0 hover:bg-neutral-50/80 transition-colors">
...
export function VoiceAgentsPage({ onStartAvatar }: { onStartAvatar?: () => void }) {
